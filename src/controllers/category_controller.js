...
export const listarProdutosPorNomeCategoria = async (req, res) => {
  ...
  try {
    ...
    console.error("Erro ao listar produtos por nome da categoria:", error);
    res.status(500).json({
      erro: "Erro interno ao buscar produtos por nome da categoria.",
    });
  }
};
